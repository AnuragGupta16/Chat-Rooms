  ...
  return (
    ...
    >
      <GridItem justifySelf="start" m="2">
        <Image src="https://w7.pngwing.com/pngs/273/74/png-transparent-online-chat-livechat-chat-room-baycreative-inc-google-icon-blue-text-logo.png" height="30px" ml="2" />
      </GridItem>
      {auth.user() ? (
        <>
